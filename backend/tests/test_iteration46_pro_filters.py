...
class TestManualPositionSafety:
    """Test that manual positions allow TREND_EXIT."""
    
    def test_trend_exit_allowed_for_manual_positions(self):
        """Manual position safety allows TREND_EXIT (not blocked by manual guard)."""
        from engine.exit_engine import ExitReason
        ...
        allowed_manual_exits = [
            ...
            ExitReason.TP_CAP,
            ExitReason.TREND_EXIT,  # NEW - should be allowed
        ]
        
        assert ExitReason.TREND_EXIT in allowed_manual_exits, "TREND_EXIT should be allowed for manual positions"
