...
Обновлено: 2026-09-02 (UTC+3)

| Дата | ID | Заголовок | Файл |
|------|----|-----------|------|
| 2026-09-02 | `a949f16f` / **02.09.26-ИП-ОТ-ПБ** | Регистрация ИП под услуги ОТ/ПБ (ot-pb.by), коды ОКРБ | [открыть в браузере HTML](archive/02.09.26-IP-OT-PB.html) · [md](archive/02.09.26-IP-OT-PB.md) |
