...
# Silence verbose transport logs from Telegram polling stack.
...
async def main():
    ...
    try:
        ...
        try:
            # Ensure aiohttp session is closed even on startup failures
            # (e.g., expired API key before entering bot.run main loop).
            if startup_failed:
